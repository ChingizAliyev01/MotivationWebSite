...
const Home = () => {
  return (
    <div className="home-container">
      ...
      <p>
        Davamlılığın hikayələrini kəşf edin, digərlərinin paylaştığı bilikləri qəbul edin və sizin səyahətinizi dəyişən motivasiyayı tapın. Uğurların müəyyən bir addım ilə başladığına inanın və biz bu addımı sizinlə birgə atmağa hazırıq.
      </p>
      <p>
